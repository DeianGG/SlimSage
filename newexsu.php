...
<body>
    <header>
        ...
        <nav class="navbar">
            <ul class="navbar__links">
                ...
                <li><button id="logind" >Logheaza-te</button></li>
                <?php 
                } else{ ?>
                <form action="destroy.php">
                    <li><button type="submit">Delogheaza-te</button></li>
                </form>
                <?php }
                ?>
            </ul>
    ...
    <section class="adaugare">
        <form action="adaugaresu.php" method="POST">
            ...
            <button type="submit" name="adaugaresu" >Sugereaza</button>
        </form>
    </section>
    <footer>
