...
<body>
    ...
    <section class="adaugare">
        <form action="adaugareret.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="adaugare__link">
                <p>Adauga o poza:<p>
                <input type="file" class="form-control" id="photo" name="photo" aria-label="file example" required>
            </div>
